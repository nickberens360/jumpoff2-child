...
<div class="colorFixed">
    <span class="js-colorFixed-close colorFixed__close"><i class="fa fa-thumb-tack" aria-hidden="true"></i></span>
    <div class="colorFixed__overlow">
    <?php include '../components/siteColors/colors.php'?>
    </div>
</div>
...
<div class="grid-row atoms-container editorMode">
    ...
    <aside class="atoms-side">
        <div class="atoms-overflow">
            ...
            <div class="atomicWp">
                <a href="/wp-admin" class="atomicWp__link" target="_blank">Admin</a>
                <a href="/" class="atomicWp__link" target="_blank">Front</a>
            </div>
